...
The 5-minute interval, on average across all the days in the dataset, which contains the maximum number of steps is `r ans`.
...
The total number of missing rows in the original dataset is `r nrna`.
